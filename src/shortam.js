...
new Shortcode(document.querySelector('body'), {
  alert: function() {
    var alert = '<div style="width:'+this.options.width+'%" id="'+this.options.id+'" class="shortam-alert shortam-bg-'+this.options.type+'">'+this.options.text+'</div>'
    return alert;
  }
});
    new Shortcode(document.querySelector('body'), {
  bt: function() {
var bt = '<a id="'+this.options.id+'" href="'+this.options.href+'" class="shortam-bt shortam-bg-'+this.options.type+'" target="'+this.options.target+'">'+this.options.text+'</a>';
    return bt;
  }
});
